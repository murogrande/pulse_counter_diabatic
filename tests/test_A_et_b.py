...
def test_b_direct_2_qubits():
    ...
    expected_b[0] = -dOmega_t[0]
    expected_b[1] = -dMu_t[0]
    expected_b[2] = -dNu_t[0]
    expected_b[3] = -dOmega_t[1]
    expected_b[4] = -dMu_t[1]
    expected_b[5] = -dNu_t[1]

    torch.allclose(b_vector, expected_b)
